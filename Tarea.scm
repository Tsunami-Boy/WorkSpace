...
(define (estables_fM lista umbral fM)
  (if (equal? lista empty)
      0
      (length (umbral_cola
               (aplicar fM (lista_val lista (umbral_cola lista umbral #\M) (list ) 0) (list )); Aplicarles f
               umbral
               #\M))))
...
;(lista_val '(15 2 1 3 27 5 10) (umbral_cola '(15 2 1 3 27 5 10) 5 #\m) (list ) 0) ;Funciona
|#
