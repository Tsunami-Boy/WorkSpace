...
ob_start();
$sentencia=$conexion->prepare("SELECT * FROM `paquete` ORDER BY `Estrellas` DESC LIMIT 10");
$sentencia->execute();
...
if(isset($_GET['favID'])){
    ...
    if($sentencia->execute() === true){
        header('Location: Paquetes_Top10.php');
    }
}
        ...
        <div class="card-body">
            <table>
                ...
                <?php 
                    ...
                    <form method="post">
                    <form method="post">
                        <a name="" id="" class="btn btn-success btn-lg" href="Paquetes_Top10.php?addID=<?php echo $id; ?>" role="button">Añadir al Carrito</a>
                    </form>
                    <?php } ?>
                    </div>
                    </br>
                    ...
                    if($wishlist === false){?>
                        <div class="flex">
                            <form method="post">
                                <a name="" id="" class="btn btn-danger btn-lg" href="Paquetes_Top10.php?favID=<?php echo $id; ?>" role="button">Favorito</a>
                            </form>
                        <div>
                    <?php }else{ ?>
                        <div class="flex">
                            <form method="post">
                                <a name="" id="" class="btn btn-danger btn-lg" href="Paquetes_Top10.php?delID=<?php echo $id; ?>" role="button">Eliminar de Favorito</a>
                            </form>
                        <div>
                    <?php 
                        }
