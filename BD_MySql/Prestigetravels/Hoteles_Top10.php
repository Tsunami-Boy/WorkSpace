...
ob_start();
include("header.php");
$sentencia=$conexion->prepare("SELECT * FROM `hotel` ORDER BY `Estrellas` DESC LIMIT 10");
$sentencia->execute();
...
if(isset($_GET['favID'])){
    ...
    if($sentencia->execute() === true){
        header('Location: Hoteles_Top10.php');
    }
}
            ...
            <table>
                ...
                <?php 
                    ...
                    <div class="flex">
                        ...
                        ?>
                        <form method="post">
                            <a name="" id="" class="btn btn-success btn-lg" href="Hoteles_Top10.php?addID=<?php echo $id; ?>" role="button">Añadir al Carrito</a>
                        </form>
                        <?php }?>
                    </div>
                    </br>
                    ...
                    if($wishlist === false){?>
                        <div class="flex">
                            <form method="post">
                                <a name="" id="" class="btn btn-danger btn-lg" href="Hoteles_Top10.php?favID=<?php echo $id; ?>" role="button">Favorito</a>
                            </form>
                        <div>
                    <?php }else{ ?>
                        <div class="flex">
                            <form method="post">
                                <a name="" id="" class="btn btn-danger btn-lg" href="Hoteles_Top10.php?delID=<?php echo $id; ?>" role="button">Eliminar de Favorito</a>
                            </form>
                        <div>
                    <?php 
                        }
                    ...
                    <p><a name="" id="" class="btn btn-primary btn-lg" href="Pagina_plantilla.php?IDh=<?php echo $id; ?>" role="button">Ir al Sitio</i></a></p>
                </td>
            </table>
        </div>
        </div>
